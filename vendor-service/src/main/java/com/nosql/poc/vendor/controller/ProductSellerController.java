...
public class ProductSellerController {
    ...
    public ResponseEntity<SimpleProductSeller> addSellerToProduct(@Valid @RequestBody SimpleProductSeller productSeller) {
        SimpleProductSeller saved = productSellerService.addSellerToProduct(productSeller);
    ...
    public ResponseEntity<List<SimpleProductSeller>> getProductSellers(@PathVariable String productId) {
    ...
    public ResponseEntity<List<SimpleProductSeller>> getActiveProductSellers(@PathVariable String productId) {
    ...
    public ResponseEntity<SimpleProductSeller> getPrimarySeller(@PathVariable String productId) {
    ...
    public ResponseEntity<List<SimpleProductSeller>> getSecondarySellers(@PathVariable String productId) {
    ...
    public ResponseEntity<SimpleProductSeller> updateSellerInfo(
            @PathVariable String productId,
            @PathVariable String vendorId,
            @Valid @RequestBody SimpleProductSeller updatedInfo) {
