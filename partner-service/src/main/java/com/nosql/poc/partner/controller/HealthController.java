...
public class HealthController {
    ...
    @Operation(
        ...
        description = "Returns the current status of the partner service and related components",
        responses = {
            @ApiResponse(
                responseCode = "200",
    ...
    public ResponseEntity<Map<String, Object>> getServiceStatus() {
        ...
        status.put("service", "partner-service");
    ...
    public ResponseEntity<Map<String, String>> getReadiness() {
        return ResponseEntity.ok(Map.of(
            "status", "READY",
            "message", "Partner service is ready to accept requests"
        ));
    }
