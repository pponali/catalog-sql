...
public class SellerProduct extends BaseEntity {
    ...
    /**
     * Transient field for seller name, populated from vendor service
     */
    @Transient
    private String sellerName;
    
    /**
     * Transient field for seller code, populated from vendor service
     */
    @Transient
    private String sellerCode;
    
    /**
     * Get the seller ID from the seller entity relationship
     */
    @Transient
